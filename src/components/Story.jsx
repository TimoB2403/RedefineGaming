      ...
      <div className='flex size-full flex-col items-center py-10 pb-24'>
        ...
        <div className='-mt-80 flex w-full justify-center md:-mt-64 md:me-44 md:justify-end'>
            <div className='flex h-full w-fit flex-col items-center md:items-start'>
                <p className='mt-3 max-w-sm tex-center font-circular-web text-violet-50 md:text-start'>
                    Where realms converge, lies Zentry and boundless pillar. Discover its secrets and shape your fate amidst infinite opportunities.</p>
